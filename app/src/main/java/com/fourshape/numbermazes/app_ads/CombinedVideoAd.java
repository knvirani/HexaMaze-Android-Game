...
public class CombinedVideoAd {
    ...
    private void loadRewardedVideoAd () {
        ...
        MobileAds.initialize(context, new OnInitializationCompleteListener() {
            ...
            public void onInitializationComplete(@NonNull @NotNull InitializationStatus initializationStatus) {
                ...
                if (!new SharedData(context).getGameSoundStatus()) {
                    MobileAds.setAppMuted(true);
                    MakeLog.info(TAG, "Load Muted Ads");
                }
                ...
                RewardedAd.load(context, PlacementIds.REWARD_MAZE_BOX_AD, adRequest, rewardedAdLoadCallback);
    ...
    private void loadRewardedInterstitialAd () {
        ...
        AdRequest adRequest = new AdRequest.Builder().build();
        RewardedInterstitialAd.load(context, PlacementIds.REWARDED_INTERSTITIAL_MAZE_BOX, adRequest, rewardedInterstitialAdLoadCallback);
    ...
    private void loadInterstitialAd () {
        ...
        InterstitialAd.load(context, PlacementIds.INTERSTITIAL_MAZE_BOX, adRequest, interstitialAdLoadCallback);
