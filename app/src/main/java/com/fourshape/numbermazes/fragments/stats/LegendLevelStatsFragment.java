...
public class LegendLevelStatsFragment extends Fragment {
    ...
    private final static int STATS_ID = StatsId.LEGEND;

    private AppColor appColor;

    public LegendLevelStatsFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mainView = inflater.inflate(R.layout.fragment_legend_level_stats, container, false);
