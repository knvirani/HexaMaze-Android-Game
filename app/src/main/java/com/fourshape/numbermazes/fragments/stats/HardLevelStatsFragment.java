...
public class HardLevelStatsFragment extends Fragment {
    ...
    private final static int STATS_ID = StatsId.HARD;

    private AppColor appColor;

    public HardLevelStatsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mainView = inflater.inflate(R.layout.fragment_hard_level_stats, container, false);
