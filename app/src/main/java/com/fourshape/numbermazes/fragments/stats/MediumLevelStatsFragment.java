...
public class MediumLevelStatsFragment extends Fragment {
    ...
    private final static int STATS_ID = StatsId.MEDIUM;

    private AppColor appColor;

    public MediumLevelStatsFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mainView = inflater.inflate(R.layout.fragment_medium_level_stats, container, false);
